	...
	<script>
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					loginName: {
						remote: "${ctx}/admin/cteateUser/checkLoginName"
					}
				},
				messages: {
					loginName: {
...
<body>
	<form id="inputForm" action="${ctx}/admin/cteateUser" method="post" class="form-horizontal">
		<fieldset>
	 	...
	 	<div class="control-group">
				...
				<div class="controls">
					<select name="roles"> 
						<option value="TwoAdmin">二级分销商</option>
						<option value="ThreeAdmin">三级分销商</option>
