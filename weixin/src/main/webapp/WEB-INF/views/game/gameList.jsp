...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>游戏名称</th><th>游戏序号</th><th>游戏广告语</th><th>最大发码数</th><th></th> <th>总码数</th> <th>已发码数</th><th>剩余码数</th> <th>状态</th> <th>管理</th></tr></thead>
		<tbody>
		<c:forEach items="${games}" var="task">
			<tr> 
				...
				<a href="#" onclick="confirmDelete('${ctx}/game/delete/${task.id}')">删除</a>
