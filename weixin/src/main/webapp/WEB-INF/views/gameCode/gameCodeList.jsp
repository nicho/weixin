...
<body>
	...
	<div><a class="btn" href="${ctx}/gameCode/create">创建游戏码</a></div> <br>
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>游戏名</th><th>游戏码</th><th>状态</th><th>领取用户</th>  <th>管理</th></tr></thead>
		<tbody>
		<c:forEach items="${gameCodes}" var="task">
			<tr> 
				...
				<a href="#" onclick="confirmDelete('${ctx}/gameCode/delete/${task.id}')">删除</a>
