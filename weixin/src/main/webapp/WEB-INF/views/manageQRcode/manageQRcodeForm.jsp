...
<body>
	<form id="inputForm" action="${ctx}/manageQRcode/${action}" method="post" class="form-horizontal">
		<input type="hidden" name="id" value="${task.id}"/>
		<fieldset>
			<legend><small>管理任务二维码</small></legend>
			<div class="control-group">
				<label for="task_title" class="control-label">任务二维码名称:</label>
				<div class="controls">
